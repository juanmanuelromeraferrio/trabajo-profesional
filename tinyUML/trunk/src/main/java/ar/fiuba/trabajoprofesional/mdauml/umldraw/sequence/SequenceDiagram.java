...
public class SequenceDiagram extends GeneralDiagram {
    ...
    protected Map<ElementType, UmlDiagramElement> setupElementPrototypeMap() {
        ...
        LifeLineElement lifeLinePrototype =
            (LifeLineElement) LifeLineElement.getPrototype().clone();
    ...
    protected Map<RelationType, UmlConnection> setupConnectionPrototypeMap() {
        ...
        SynchronousMessageConnection msgConn =
            (SynchronousMessageConnection) SynchronousMessageConnection.getPrototype().clone();
