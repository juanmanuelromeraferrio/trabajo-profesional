 ...
 * @version 1.0
 */
@SuppressWarnings("PMD") public class EditClassDialog extends javax.swing.JDialog {
     ...
     */
    public EditClassDialog(java.awt.Window parent, ClassElement aClassElement, boolean modal) {
    ...
    public boolean showOperations() {
        return methodVisibilityCb.isSelected();
    }
    ...
    public boolean showAttributes() {
        return attributeVisibilityCb.isSelected();
    }
    ...
    public List<UmlProperty> getMethods() {
        List<String> methodStrings = ((StringTableModel) methodTable.getModel()).getEntries();
    ...
    public List<UmlProperty> getAttributes() {
        List<String> attributeStrings = ((StringTableModel) attributeTable.getModel()).getEntries();
        List<UmlProperty> result = new ArrayList<UmlProperty>();
    ...
    public List<UmlStereotype> getStereotypes() {
        List<String> stereoStrings = ((StringTableModel) stereotypeTable.getModel()).getEntries();
    ...
    private void initComponents() {
        ...
        attributeTable.getSelectionModel()
            ...
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel1Layout.createSequentialGroup().addGroup(
                    jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(attributeVisibilityCb).addGroup(
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel1Layout.createSequentialGroup().addComponent(attributeVisibilityCb)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                    jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                            jPanel1Layout.createSequentialGroup().addComponent(attribMoveUpButton)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(attribMoveDownButton))
                    ...
                    jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(attribDeleteButton).addComponent(attribAddButton))
                    .addContainerGap()));
            ...
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel2Layout.createSequentialGroup().addGroup(
                    jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(methodVisibilityCb).addGroup(
        ...
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel2Layout.createSequentialGroup().addComponent(methodVisibilityCb)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                    jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout
                                ...
                                .addComponent(methodDeleteButton).addComponent(methodAddButton)))
                        .addGroup(
                            jPanel2Layout.createSequentialGroup().addComponent(methodMoveUpButton)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(methodMoveDownButton)))
        ...
        propertyPanelLayout.setHorizontalGroup(
            propertyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(propertyPanelLayout.createSequentialGroup().addGroup(propertyPanelLayout
                    .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        propertyPanelLayout.createSequentialGroup().addContainerGap()
                            .addComponent(jLabel1)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(nameTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 402,
                                Short.MAX_VALUE))
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel2, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(propertyPanelLayout.createSequentialGroup().addContainerGap()
                        .addComponent(abstractCb))).addContainerGap()));
        propertyPanelLayout.setVerticalGroup(
            propertyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(propertyPanelLayout.createSequentialGroup().addContainerGap().addGroup(
                    propertyPanelLayout
                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel1)
                    ...
                    jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                    163, Short.MAX_VALUE).addComponent(addStereotypeButton)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(deleteStereotypeButton))
                            .addComponent(stereoScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE,
                                367, Short.MAX_VALUE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel3Layout
                                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                    false).addComponent(stereotypeMoveDownButton,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(stereotypeMoveUpButton,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addComponent(stereotypeVisibilityCb)).addContainerGap()));
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel3Layout.createSequentialGroup().addContainerGap()
                    .addComponent(stereotypeVisibilityCb).addGap(15, 15, 15).addGroup(
                    jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            .addComponent(stereotypeMoveUpButton)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(stereotypeMoveDownButton))
                        .addComponent(stereoScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                            javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
            ...
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel4Layout.createSequentialGroup().addContainerGap().addGroup(
                    jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 472,
                            Short.MAX_VALUE).addComponent(docVisibilityCb)).addContainerGap()));
        ...
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(tabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 497,
                    Short.MAX_VALUE).addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                layout.createSequentialGroup().addContainerGap(320, Short.MAX_VALUE)
                    .addComponent(okButton, javax.swing.GroupLayout.PREFERRED_SIZE, 77,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(cancelButton, javax.swing.GroupLayout.PREFERRED_SIZE, 84,
                        javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()));
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    .addComponent(tabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 533,
                        Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
    ...
    private void moveDownSelectedStereotype(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveDownSelectedStereotype
        moveDownSelectedTableEntry(stereotypeTable);
    }//GEN-LAST:event_moveDownSelectedStereotype

    private void moveUpSelectedStereotype(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveUpSelectedStereotype
        moveUpSelectedTableEntry(stereotypeTable);
    }//GEN-LAST:event_moveUpSelectedStereotype

    private void deleteSelectedStereotype(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteSelectedStereotype
    ...
    private void moveDownSelectedMethod(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveDownSelectedMethod
        moveDownSelectedTableEntry(methodTable);
    }//GEN-LAST:event_moveDownSelectedMethod

    private void moveUpSelectedMethod(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveUpSelectedMethod
        moveUpSelectedTableEntry(methodTable);
    }//GEN-LAST:event_moveUpSelectedMethod

    private void deleteSelectedMethod(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteSelectedMethod
    ...
    private void addMethod(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addMethod
        ((StringTableModel) methodTable.getModel()).addEntry("+method(param1, param2) : Type");
    }//GEN-LAST:event_addMethod

    private void moveDownSelectedAttribute(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveDownSelectedAttribute
        moveDownSelectedTableEntry(attributeTable);
    }//GEN-LAST:event_moveDownSelectedAttribute

    private void moveUpSelectedAttribute(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveUpSelectedAttribute
        moveUpSelectedTableEntry(attributeTable);
    }//GEN-LAST:event_moveUpSelectedAttribute

    private void deleteSelectedAttribute(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteSelectedAttribute
