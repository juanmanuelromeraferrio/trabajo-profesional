...
public class EditUseCaseDialog extends javax.swing.JDialog {
  ...
  private JList<MainFlowStep> mainFlowsSteps;
  ...
  private void initComponents() {
    ...
    mainActorsPanel.setBorder(
        new TitledBorder(null, "Main actors", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        gl_panel_1.createParallelGroup(Alignment.LEADING).addGap(0, 82, Short.MAX_VALUE)
            .addGroup(gl_panel_1.createSequentialGroup().addGap(6)
                ...
                .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                    Short.MAX_VALUE).addComponent(removeSecondaryActors))
            .addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(scrollPane_2,
    ...
    gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING)
        .addGroup(gl_panel_2.createSequentialGroup().addContainerGap()
            ...
            .addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
                gl_panel_2.createParallelGroup(Alignment.LEADING, false)
                    .addComponent(addPreconditions, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(editPreconditions, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                        63, Short.MAX_VALUE))
                .addComponent(deletePreconditions, GroupLayout.PREFERRED_SIZE, 61, Short.MAX_VALUE))
            .addContainerGap()));
    gl_panel_2
        .setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
            ...
            .addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
                .addComponent(scrollPane_3, GroupLayout.PREFERRED_SIZE, 52,
                    GroupLayout.PREFERRED_SIZE)
                .addGroup(gl_panel_2.createSequentialGroup().addComponent(editPreconditions)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(deletePreconditions)))
    ...
    JButton addMainFlow = new JButton("Add");

    addMainFlow.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
            ...
            .addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
                .addGroup(Alignment.TRAILING,
                    gl_panel_3.createParallelGroup(Alignment.LEADING, false)
                        .addComponent(addMainFlow, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                            GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(button_4, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 63,
                            Short.MAX_VALUE))
        ...
        gl_panel_3.createParallelGroup(Alignment.LEADING).addGap(0, 114, Short.MAX_VALUE)
            .addGroup(gl_panel_3.createSequentialGroup().addGap(6)
                .addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE)
                    .addComponent(addMainFlow).addComponent(textField_2, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
            .addGap(8)
            .addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_panel_3.createSequentialGroup().addComponent(button_4)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(button_7))
                .addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE).addComponent(
                    scrollPane_4, GroupLayout.PREFERRED_SIZE, 147, GroupLayout.PREFERRED_SIZE)))
            .addContainerGap(29, Short.MAX_VALUE)));
    ...
    panel_4.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Postconditions",
        TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    gl_panel_4.setHorizontalGroup(
        gl_panel_4.createParallelGroup(Alignment.TRAILING).addGap(0, 426, Short.MAX_VALUE)
            ...
            .addPreferredGap(ComponentPlacement.UNRELATED)
            .addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
                gl_panel_4.createParallelGroup(Alignment.LEADING, false)
                    .addComponent(addPostconditions, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(editPostConditions, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                        63, Short.MAX_VALUE))
    ...
    gl_panel_4.setVerticalGroup(
        gl_panel_4.createParallelGroup(Alignment.LEADING).addGap(0, 114, Short.MAX_VALUE)
            .addGroup(gl_panel_4.createSequentialGroup().addGap(6)
                .addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE)
                    .addComponent(addPostconditions).addComponent(postconditionTextField,
                        GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE))
            .addGap(8)
            .addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_panel_4.createSequentialGroup().addComponent(editPostConditions)
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addComponent(deletePostoconditions))
                .addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(
                    scrollPane_5, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)))
            .addContainerGap(29, Short.MAX_VALUE)));
                    ...
                    gl_panel_5.createSequentialGroup().addContainerGap()
                        ...
                        .addGroup(gl_panel_5.createParallelGroup(Alignment.TRAILING)
                            .addGroup(gl_panel_5.createSequentialGroup()
                                .addComponent(button_13, GroupLayout.DEFAULT_SIZE, 67,
                                    Short.MAX_VALUE)
                                .addContainerGap())
                    .addGroup(gl_panel_5.createSequentialGroup()
                        .addGroup(gl_panel_5.createParallelGroup(Alignment.TRAILING)
            ...
            .addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING, false)
                .addGroup(Alignment.TRAILING,
                    gl_panel_5.createSequentialGroup().addComponent(btnAdd_1)
                        .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                            Short.MAX_VALUE)
                        .addComponent(button_11).addPreferredGap(ComponentPlacement.RELATED)
    ...
    gl_mainActorsPanel.setHorizontalGroup(gl_mainActorsPanel.createParallelGroup(Alignment.LEADING)
        .addGroup(Alignment.TRAILING, gl_mainActorsPanel.createSequentialGroup().addContainerGap()
            ...
            .addGroup(gl_mainActorsPanel.createParallelGroup(Alignment.LEADING, false)
                .addGroup(gl_mainActorsPanel.createSequentialGroup()
                    .addComponent(comboMainActor, GroupLayout.PREFERRED_SIZE, 120,
                        GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(addMainActor,
                        GroupLayout.PREFERRED_SIZE, 58, GroupLayout.PREFERRED_SIZE))
                .addComponent(deleteMainActor, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                    Short.MAX_VALUE))
            .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    gl_mainActorsPanel.setVerticalGroup(gl_mainActorsPanel.createParallelGroup(Alignment.LEADING)
        .addGroup(gl_mainActorsPanel.createSequentialGroup().addGap(6).addGroup(gl_mainActorsPanel
  ...
  private class MainFlowStep {

    public List<String> entities;
    public String description;

    public MainFlowStep(List<String> entities, String description) {
      super();
