...
public class XmlPersister implements ProjectPersister {
    ...
    @Override public void save(Project project, String path) throws ProjectPersisterException {
    ...
    @Override public Project load(String path) throws ProjectPersisterException {
        try {
            String projectPath = getProjectPath(path);
