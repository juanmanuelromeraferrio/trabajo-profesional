...
public class ProjectXmlParser implements XmlParser {
  ...
  @Override
  public Project parse(File projecFile) throws Exception {
    ...
    String modelPath =
        XmlHelper.querySingle(root, "./" + Constants.MODEL_TAG).getTextContent();
  ...
  @Override
  public Document generateXml(Project project) throws DOMException, Exception {
    DocumentBuilder docBuilder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
